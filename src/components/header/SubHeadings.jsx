...
const SubHeadings = ({ data, selectedContentIndex, showBreadCrumbs }) => {
  ...
  const contentHeading = data.data.content[selectedContentIndex].contentHeading;
  const subtitle = "Your Gateway To Crack Top Companies ⭐";
        ...
        >
          <Link to={"/"}>
            <Text
              ...
              fontStyle={"normal"}
              color={isDarkMode ? "highlightedColor_dark" : "highlightedColor"}
              cursor={"pointer"}
